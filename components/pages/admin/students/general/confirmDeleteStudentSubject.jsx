...
class DeleteStudentSubject extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      open: false,
  ...
  handleOpen = () => {
    if (this.props.studentSubjectId !== undefined) {
      this.setState({
        studentSubjectId: this.props.studentSubjectId,
        open: true,
      });
    } else {
  ...
  handleOkay = (id) => {
    this.setState({ open: false });
    this.props.deleteStudentSubject(id);
  };
  render() {
    return (
      <React.Fragment>
        <div className="">
          <button
            ...
            className="capitalize inline-flex justify-center p-1 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-red-600 hover:bg-red-500 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-red-500"
          >
            Delete
          </button>
        </div>
                ...
                >
                  <Dialog.Panel className="relative transform overflow-hidden rounded-lg bg-white px-4 pt-5 pb-4 text-left shadow-xl transition-all sm:my-8 sm:w-full sm:max-w-lg sm:p-6">
                    <Formik
                      ...
                      validationSchema={RemoveTeacherSchema()}
                      onSubmit={(formData, { resetForm }) => {
                        //var data = Object.assign({}, formData)
                        this.handleOkay(this.props.studentSubjectId);
                        resetForm({ values: "" });
                      }}
                    >
                            ...
                            <Form>
                              <div className="sm:flex sm:items-start">
                                ...
                                <div className="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                                  ...
                                  <div className="mt-2">
                                  <h1 className="text-gray-900 mb-2">Warning</h1>
                                    <p className="text-gray-600">
                                      This operation will remove associated records for grade(s) which were assigned to this student subject.
                                    </p>
                                    <h1 className="text-gray-700 mt-2">Enter the code below to confirm</h1>
...
export default DeleteStudentSubject;
