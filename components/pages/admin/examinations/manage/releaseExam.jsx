...
import { RemoveSubjectSchema } from "../../../../../services/schema/subjectChema";

class ReleaseExamination extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      open: false,
  ...
  handleOpen = () => {
    if (this.props.academicYearId !== undefined) {
      this.setState({
    ...
    return (
      <React.Fragment>
        <button
          ...
          className="capitalize inline-flex justify-center py-2 px-2 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-green-500 hover:bg-green-600 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-green-500"
        >
          Release Exam
        </button>
                ...
                >
                  <Dialog.Panel className="relative transform overflow-hidden rounded-lg bg-white px-4 pt-5 pb-4 text-left shadow-xl transition-all sm:my-8 sm:w-full sm:max-w-lg sm:p-6">
                    <Formik
                      ...
                      validationSchema={RemoveSubjectSchema()}
                      onSubmit={(formData, { resetForm }) => {
                        //var data = Object.assign({}, formData)
                        this.handleOkay(this.props.academicYearId);
                        resetForm({ values: "" });
                      }}
                    >
...
export default ReleaseExamination;
