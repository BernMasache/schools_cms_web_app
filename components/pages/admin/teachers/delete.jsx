    ...
    if (this.props.teacherId !== undefined) {
      ...
      Swal.fire({
        ...
        customClass: {
          ...
          actions: "space-x-2",
          confirmButton:
            "capitalize inline-flex items-center font-semibold bg-white px-3 py-2 text-sm font-medium leading-4 text-danger-700  rounded-sm focus:outline-none hover:bg-danger-100 focus:ring-2 focus:ring-danger-500 focus:ring-offset-2",
          cancelButton:
            " capitalize inline-flex items-center font-semibold bg-white px-3 py-2 text-sm font-medium leading-4 text-danger-700  rounded-sm focus:outline-none hover:bg-danger-100 focus:ring-2 focus:ring-danger-500 focus:ring-offset-2",
        },
      });
          ...
          <div className="md:grid md:grid-cols-1 md:gap-6">
            <div className="md:col-span-6">
              ...
              <p className="mt-1 text-sm text-gray-500">
                Deleting the teacher cannot be undone. Confirm the deletion using the provided confirmation code.
              </p>
            </div>
                  ...
                  <Dialog.Panel className="relative transform overflow-hidden rounded-lg bg-white px-4 pt-5 pb-4 text-left shadow-xl transition-all sm:my-8 sm:w-full sm:max-w-lg sm:p-6">
                    <Formik
                      ...
                      onSubmit={(formData, { resetForm }) => {
                        ...
                        this.handleOkay(this.props.teacherId);
                        resetForm({ values: "" });
                      }}
                    >
