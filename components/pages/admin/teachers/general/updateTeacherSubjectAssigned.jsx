...
export default class UpdateAssignedTeacherSubject extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      initialData: {
      ...
      <React.Fragment>
        <div>
          <button
            ...
            className="capitalize inline-flex justify-center py-2 px-2 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-orange-700 hover:bg-orange-600 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-orange-500"
          >
            Update
          </button>
                    ...
                    <Dialog.Panel className="relative transform overflow-hidden rounded-lg bg-white px-4 pt-5 pb-4 text-left shadow-xl transition-all sm:my-8 sm:w-full sm:max-w-lg sm:p-6">
                      ...
                      <div className="sm:flex sm:items-start">
                        <div className="mt-3 text-center sm:mt-0  sm:text-left">
                          <Dialog.Title
                            as="h3"
                            className="text-lg mb-8 font-medium leading-6 text-gray-900 capitalize"
                          >
                            Update Teacher Subject Assigned
                          </Dialog.Title>
                        </div>
                      </div>
                      <div>
                        {
                          <Formik
                            initialValues={{
                              teacherId: this.props.data.Teacher.uuid,
                              subjectId: this.props.data.Subject.uuid,
                              term: this.props.data.term,
                              academicYear: this.props.data.AcademicYear.uuid,
