...
class DeleteTeacherSubject extends React.Component {
  ...
  handleOkay = (id) => {
    this.setState({ open: false });
    this.props.deleteTeacherSubject(id);
  };
  render() {
    return (
      <React.Fragment>
        <div className="">
          <button
            ...
            className="capitalize inline-flex justify-center py-2 px-2 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-red-600 hover:bg-red-500 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-red-500"
          >
            Delete Student
          </button>
        </div>
                                ...
                                <div className="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                                  ...
                                  <div className="mt-2">
                                    ...
                                    <p className="text-gray-600">
                                      ...
                                      records for subjects and grades, passwords
                                      which were assigned to this student.
                                    </p>
