...
class DeleteTheSubject extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      open: false,
                  ...
                  <Dialog.Panel className="relative transform overflow-hidden rounded-lg bg-white px-4 pt-5 pb-4 text-left shadow-xl transition-all sm:my-8 sm:w-full sm:max-w-lg sm:p-6">
                    <Formik
                      ...
                      onSubmit={(formData, { resetForm }) => {
                        ...
                        this.handleOkay(this.props.subjectId);
                        resetForm({ values: "" });
                      }}
                    >
                                ...
                                <div className="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                                  ...
                                  <div className="mt-2">
                                    ...
                                    <p className="text-gray-600">
                                      This operation will remove associated records for student, teacher and grades which were assigned to this subject.
                                    </p>
...
export default DeleteTheSubject;
